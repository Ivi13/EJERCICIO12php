...
<body>
  <div class="contenedor">
    ...
    <div class="menu">
      <a href="/Registro_de_Cursos_(MVC+PDO)/public/index.php?accion=listar">📋 Listar cursos</a>
      <a href="/Registro_de_Cursos_(MVC+PDO)/public/index.php?accion=crear">➕ Nuevo curso</a>
    </div>
